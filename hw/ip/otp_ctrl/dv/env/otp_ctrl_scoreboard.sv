...
class otp_ctrl_scoreboard extends cip_base_scoreboard #(
  ...
  virtual task process_lc_token();
    forever begin
      ...
      exp_data_0 = cal_one_round_with_final_const(.data(RndCnstDigestIVDefault[1]),
                                                  .key(rcv_item.h_data),
                                                  .final_const(RndCnstDigestConstDefault[1]));
      exp_data_1 = cal_one_round_with_final_const(.data(exp_data_0),
                                                  .key(rcv_item.h_data),
                                                  .final_const(RndCnstDigestConstDefault[1]));
  ...
  virtual function bit [SCRAMBLE_DATA_SIZE-1:0] cal_one_round_with_final_const(
    ...
    cal_one_round_with_final_const = enc_array[NUM_ROUND-1];
  endfunction
